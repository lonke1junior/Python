def read_grades(gradefile):
    ...
    contrains no blank lines, then has a blank line, and
    ...
    while line != '':
        ...
        # single student.
        # Find the tab space and take everyting after
        # that tab.
...
def count_grade_ranges(grades):
    ...
    100: 10
    
    >>> count_grade_ranges([77.5, 37.5, 62.5, 0.5, 72.5, 100.0, 55.0, 70.0, 79.5])
    [1, 0, 0, 1, 0, 1, 1, 4, 0, 0, 1]
    '''
...
def write_histogram(range_counts, histfile):
    ...
    Write a histogram of *'s based on number of grades in
    each range.
